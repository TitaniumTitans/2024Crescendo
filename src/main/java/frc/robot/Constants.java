...
public final class Constants {
  ...
  public static class DriveConstants {
    ...
    public static final HolonomicPathFollowerConfig HOLONOMIC_CONFIG = new HolonomicPathFollowerConfig(
        new PIDConstants(6.0, 0.0), new PIDConstants(6.5, 1.0),
  ...
  public static class ArmConstants {
    ...
    * than the lowest point the arm and wrist will move to , and then compensate for that in our encoder reset code */
    ...
    public static final double ARM_OFFSET = -0.318115 + Units.degreesToRotations(OFFSET_NUDGE) + Units.degreesToRotations(-10.0);
  ...
  public static class ShooterConstants {
    ...
    public static final double SHOOTER_KS = 0.330;//0.21963;
    public static final double SHOOTER_KV = 0.115; //0.133
