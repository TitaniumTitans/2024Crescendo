...
"@tparam Outputs Number of outputs.";
  ...
  .def(py::init<LinearSystem<States, Inputs, Outputs>&, LinearQuadraticRegulator<States, Inputs>&, KalmanFilter<States, Inputs, Outputs>&, units::volt_t, units::second_t>(),
      py::arg("plant"), py::arg("controller"), py::arg("observer"), py::arg("maxVoltage"), py::arg("dt"), release_gil()
    , py::keep_alive<1, 2>()
    , py::keep_alive<1, 3>()
...
":param dt:         The nominal timestep.")
  ...
  .def(py::init<LinearSystem<States, Inputs, Outputs>&, LinearQuadraticRegulator<States, Inputs>&, KalmanFilter<States, Inputs, Outputs>&, std::function<InputVector (const InputVector&)>, units::second_t>(),
      py::arg("plant"), py::arg("controller"), py::arg("observer"), py::arg("clampFunction").none(false), py::arg("dt"), release_gil()
    , py::keep_alive<1, 2>()
    , py::keep_alive<1, 3>()
    , py::keep_alive<1, 4>(), py::doc(
    "Constructs a state-space loop with the given plant, controller, and\n"
...
":param dt:            The nominal timestep.")
  ...
  .def(py::init<LinearQuadraticRegulator<States, Inputs>&, const LinearPlantInversionFeedforward<States, Inputs>&, KalmanFilter<States, Inputs, Outputs>&, units::volt_t>(),
      py::arg("controller"), py::arg("feedforward"), py::arg("observer"), py::arg("maxVoltage"), release_gil()
    , py::keep_alive<1, 2>()
    , py::keep_alive<1, 3>()
    , py::keep_alive<1, 4>(), py::doc(
...
"                    that the inputs are voltages.")
  ...
  .def(py::init<LinearQuadraticRegulator<States, Inputs>&, const LinearPlantInversionFeedforward<States, Inputs>&, KalmanFilter<States, Inputs, Outputs>&, std::function<InputVector (const InputVector&)>>(),
      py::arg("controller"), py::arg("feedforward"), py::arg("observer"), py::arg("clampFunction").none(false), release_gil()
    , py::keep_alive<1, 2>()
    , py::keep_alive<1, 3>()
    , py::keep_alive<1, 4>(), py::doc(
...
":param clampFunction: The function used to clamp the input vector.")
  ...
  .
def
("xhat", static_cast<const StateVector&(frc::LinearSystemLoop<States, Inputs, Outputs>::*)() const>(
  ...
  .
def
("xhat", static_cast<double(frc::LinearSystemLoop<States, Inputs, Outputs>::*)(int) const>(
...
":param i: Row of x-hat.")
  ...
  .
def
("nextR", static_cast<const StateVector&(frc::LinearSystemLoop<States, Inputs, Outputs>::*)() const>(
  ...
  .
def
("nextR", static_cast<double(frc::LinearSystemLoop<States, Inputs, Outputs>::*)(int) const>(
...
":param i: Row of r.")
  ...
  .
def
("U", static_cast<InputVector(frc::LinearSystemLoop<States, Inputs, Outputs>::*)() const>(
  ...
  .
def
("U", static_cast<double(frc::LinearSystemLoop<States, Inputs, Outputs>::*)(int) const>(
...
":param i: Row of u.")
  ...
  .
def
("setXhat", static_cast<void(frc::LinearSystemLoop<States, Inputs, Outputs>::*)(const StateVector&)>(
...
":param xHat: The initial state estimate x-hat.")
  ...
  .
def
("setXhat", static_cast<void(frc::LinearSystemLoop<States, Inputs, Outputs>::*)(int, double)>(
        &frc::LinearSystemLoop<States, Inputs, Outputs>::SetXhat),
...
":param value: Value for element of x-hat.")
  ...
  .
def
("setNextR", &frc::LinearSystemLoop<States, Inputs, Outputs>::SetNextR,
...
":param nextR: Next reference.")
  ...
  .
def
("reset", &frc::LinearSystemLoop<States, Inputs, Outputs>::Reset,
...
":param initialState: The initial state.")
  ...
  .
def
("error", &frc::LinearSystemLoop<States, Inputs, Outputs>::Error, release_gil(), py::doc(
  ...
  .
def
("correct", &frc::LinearSystemLoop<States, Inputs, Outputs>::Correct,
...
":param y: Measurement vector.")
  ...
  .
def
("predict", &frc::LinearSystemLoop<States, Inputs, Outputs>::Predict,
...
":param dt: Timestep for model update.")
  ...
  .
def
("clampInput", &frc::LinearSystemLoop<States, Inputs, Outputs>::ClampInput,
