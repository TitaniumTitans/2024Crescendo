...
using BindType = rpygen::bind_frc__SwerveDriveWheelPositions<3>;
static std::unique_ptr<BindType> inst;

bind_frc__SwerveDriveWheelPositions_1::bind_frc__SwerveDriveWheelPositions_1(py::module &m, const char * clsName)
{
    inst = std::make_unique<BindType>(m, clsName);
}

void bind_frc__SwerveDriveWheelPositions_1::finish(const char *set_doc, const char *add_doc)
{
